...
export const boardReducer = (state = initialState, action) => {
    switch (action.type) {
        ...
        case ACTIONS.GET_BOARDS:
            return { ...state, loading: false, boards: action.payload.boards, newBoard: undefined }
        case ACTIONS.GET_BOARD_BY_ID:
            return { ...state, loading: false, currBoard: action.payload.currBoard, newBoard: undefined }
        case ACTIONS.ERROR_BOARD:
            return { ...state, loading: false, error: action.payload.error, boards: [], newBoard: undefined }
        ...
        case ACTIONS.UPDATE_BOARD:
            ...
            return { ...state, boards: boardsCopy, currBoard: action.payload.board, loading: false, newBoard: undefined }
        case ACTIONS.DELETE_BOARD:
            ...
            return { ...state, boards: boardPrev, loading: false, newBoard: undefined }
        default:
            return state
    }
}
